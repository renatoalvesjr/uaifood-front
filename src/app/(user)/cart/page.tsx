...
export default function CartPage() {
  ...
  // Utiliza o valor total fornecido pela API
  const totalCartValue = totalValue;

  const handleUpdateQuantity = (itemId: number, quantity: number) => {
    if (quantity < 1) {
      // O itemId aqui é o ID do Item (não do OrderItem)
        ...
        <div className="space-y-4">
          {cartItems.map((item) => ( 
            ...
            >
              ...
              {/* Subtotal - Usando cálculo local (unitPrice * quantity) */}
